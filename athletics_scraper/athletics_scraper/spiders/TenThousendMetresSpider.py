...
class TenThousandMetresSpider(scrapy.Spider):
    name = "ten_thousand_metres_spider"
    allowed_domains = ["worldathletics.org"]
    start_urls = [
        f'https://worldathletics.org/records/all-time-toplists/middlelong/10000-metres/all/men/senior?regionType=world&page={page}&bestResultsOnly=false&firstDay=1900-01-01&lastDay=2024-06-03&maxResultsByCountry=all&eventId=10229610&ageCategory=senior'
        for page in range(1, 53)
    ]

    bannister_like_threshold = "27:00.00"
    limit_time = "28:10.00"
